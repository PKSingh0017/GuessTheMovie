...
movies_bollywood = ['sholay',
'tees maar khan', 'my name is khan', 'masaan', 'lagaan', 'queen',
'devdas', 'dangal', 'rang de basanti',  'hum aapke hain kaun',
'zindagi na milegi dobara', 'gangs of wasseypur',
'taare zameen par', 'hera pheri','pati patni aur woh',
'yeh jawaani hai deewani', 'kabir singh', 'bajrangi bhaijaan', 'deewaar',
 'tanhaji', 'chhapaak','good newwz','dabangg','luka chuppi','house full','mission mangal','gully boy',
'student of the year','dream girl','chhichhore','made in china']

# movies = movies_hollywood[ : ]
movies = movies_bollywood[ : ]
A = 20
B = 20
C = 20
R = 1
